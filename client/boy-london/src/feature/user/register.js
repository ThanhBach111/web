    ...
    return(
        <div style={styles.page}>
            ...
            <div style={styles.forminput}>
                ...
                <input type="text" style={styles.textInput} placeholder={"HỌ VÀ TÊN"}></input>
                </div>
                <div style={styles.forminput}>
                ...
                <input type="text" style={styles.textInput} placeholder={"SỐ ĐIỆN THOẠI"}></input>
                </div>
                <div style={styles.forminput}>
                <img src={Images.home} style={styles.image} />
                <input type="text" style={styles.textInput} placeholder={"ĐỊA CHỈ"}></input>
                </div>
                <div style={styles.forminput}>
